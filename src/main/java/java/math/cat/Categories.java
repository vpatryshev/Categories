...
import static java.math.cat.BasePair.withLeft;
...
public final class Categories {
  ...
  public static final Category<String, String> PARALLEL_PAIR =
      Category(Graph(Sets.Set("0", "1"), Map(array("a", "b"), array(Pair("0", "1"), Pair("0", "1")))), null);
  ...
  public static Category<Set, TypelessSetMorphism> SETF =
      new Category<Set, TypelessSetMorphism>(BigSet.FINITE_SETS) {
        ...
        public Pair<TypelessSetMorphism, TypelessSetMorphism> union(Set x, Set y) {
          Functions.Injection tagX = withLeft("x");
          Functions.Injection tagY = withLeft("y");
        ...
        public Pair<TypelessSetMorphism, TypelessSetMorphism> pullback(
          ...
          return Pair(TypelessSetMorphism.compose(pullbackToProduct, product.x()), TypelessSetMorphism.compose(pullbackToProduct, product.y()));
        }
        ...
        public Pair<TypelessSetMorphism, TypelessSetMorphism> pushout(
          ...
          return Pair(TypelessSetMorphism.compose(union.x(), coequalizer), TypelessSetMorphism.compose(union.y(), coequalizer));
        }
