...
public class SetDiagram<Objects, Arrows>
  ...
  public Functor<Objects, Arrows, Set, TypelessSetMorphism>.Cocone colimit() {
    ...
    Function<Objects, Injection<Object, Pair<Integer, Object>>> objectToInjection = reverseIndex.then(Functions.forList(Pair(du.unionSet(), du.injections()).y()));
    final Sets.FactorSet factorset = new Sets.FactorSet(Pair(du.unionSet(), du.injections()).x());
