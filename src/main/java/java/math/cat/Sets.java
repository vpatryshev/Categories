...
import static java.math.cat.Base.buildProductIterator;
import static java.math.cat.Base.concat;
import static java.math.cat.Base.countEntries;
import static java.math.cat.Base.range;
import static java.math.cat.Base.zip;

import java.math.cat.Base;
import java.math.cat.BasePair;
import java.math.cat.Functions;

import java.math.cat.Functions.Function;
import java.math.cat.Functions.Inclusion;
import java.math.cat.Functions.Injection;
import java.math.cat.Functions.IterableToSet;
import java.math.cat.Functions.PairsToMap;
