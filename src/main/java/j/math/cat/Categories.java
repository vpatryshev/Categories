...
import static j.math.cat.Category.Graph;
...
public final class Categories {
  ...
  static class SetCategory extends Category<Set<Object>, TypelessSetMorphism> {
    ...
    public boolean isMonomorphism(final TypelessSetMorphism arrow) {
      return new Predicate<Pair<Object, Object>>() {
        ...
        public boolean eval(final Pair<Object, Object> p) {
          return !Base.equal(arrow.apply(p.x()), arrow.apply(p.y())) ||  Base.equal(p.x(), p.y());
        }
    ...
    public TypelessSetMorphism coequalizer(TypelessSetMorphism f, TypelessSetMorphism g) {
      ...
      Sets.FactorSet<Object> factorset = new Sets.FactorSet<>(f.codomain());
    ...
    @Override
    public TypelessSetMorphism coequalizer(final Iterable<TypelessSetMorphism> arrowsToCoequalize, Set<Object> codomain) {
      if (!arrowsToCoequalize.iterator().hasNext()) {
        return TypelessSetMorphism.unitMorphism(codomain);
      }
      Sets.FactorSet<Object> factorset = new Sets.FactorSet<>(codomain);
      Set domain = null;
      for (TypelessSetMorphism f : arrowsToCoequalize) {
      ...
      for (TypelessSetMorphism g : arrowsToCoequalize) {
        if (f != null) {
