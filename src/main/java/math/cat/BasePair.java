...
public class BasePair<X, Y> extends Pair<X, Y> {
   ...
   */
  public static <X, Y> Injection<Y, Pair<X, Y>> withLeft(final X x) {
    return new Injection<Y, Pair<X, Y>>() {
   ...
   */
  public static <X, Y> Injection<X, Pair<X, Y>> withRight(final Y y) {
    return new Injection<X, Pair<X, Y>>() {
