...
import static math.cat.Base.buildProductIterator;
import static math.cat.Base.concat;
import static math.cat.Base.countEntries;
import static math.cat.Base.range;
import static math.cat.Base.zip;
import math.cat.Functions.Function;
import math.cat.Functions.Inclusion;
import math.cat.Functions.Injection;
import math.cat.Functions.IterableToSet;
import math.cat.Functions.PairsToMap;
