...
class GraphTest extends Specification {
  ...
  "Graph" >> {
    ...
    "are parallel" >> {
      val sut = Graph(Set(1, 2, 3), Set(11, 111, 21, 32, 13, 113), (x: Int) => x / 10 % 10, (x: Int) => x % 10)
    ...
    "equal" >> {
      val sut1 = Graph(Set(1, 2, 3), Set(11, 111, 21, 32, 13, 113), (x: Int) => x / 10 % 10, (x: Int) => x % 10)
      val sut2 = Graph(Set(1, 2, 3), Set(11, 111, 21, 32, 13, 113), (x: Int) => x / 10 % 10, (x: Int) => x % 10)
      val sut3 = Graph(Set(1, 2, 3), Set(11, 111, 21, 32, 13), (x: Int) => x / 10 % 10, (x: Int) => x % 10)
      val sut4 = Graph(Set(1, 2, 3, 4), Set(11, 111, 21, 32, 13), (x: Int) => x / 10 % 10, (x: Int) => x % 10)
