...
//  }
  ...
  "Subobject classifier" should {
    ...
    "exist for _2_" in {
      ...
      points(1).toString ===
        "Point(0→(0→{}, 1→{0.1}), 1→(0→{}, 1→{1.1}))"

      points(2).toString ===
        "Point(0→(0→{0.0}, 1→{0.1}), 1→(0→{}, 1→{1.1}))"
    }
    ...
    "exist for _3_" in {
      ...
      points.size === 4
      points(0).toString ===
        "Point(0→(0→{}, 1→{}, 2→{}), 1→(0→{}, 1→{}, 2→{}), 2→(0→{}, 1→{}, 2→{}))"

      points(1).toString ===
        "Point(0→(0→{}, 1→{}, 2→{0.2}), 1→(0→{}, 1→{}, 2→{1.2}), 2→(0→{}, 1→{}, 2→{2.2}))"

      points(2).toString ===
        "Point(0→(0→{}, 1→{0.1}, 2→{0.2}), 1→(0→{}, 1→{1.1}, 2→{1.2}), 2→(0→{}, 1→{}, 2→{2.2}))"

      points(3).toString ===
        "Point(0→(0→{0.0}, 1→{0.1}, 2→{0.2}), 1→(0→{}, 1→{1.1}, 2→{1.2}), 2→(0→{}, 1→{}, 2→{2.2}))"
    }
    ...
    "exist for ParallelPair" in {
      ...
      points(1).toString ===
        "Point(0→(0→{}, 1→{a,b}), 1→(0→{}, 1→{1}))"

      points(2).toString ===
        "Point(0→(0→{0}, 1→{a,b}), 1→(0→{}, 1→{1}))"
    }
    ...
    "exist for Pullback" in {
      ...
      points.size === 5
      points(0).toString ===
        "Point(a→(a→{}, b→{}, c→{}), b→(a→{}, b→{}, c→{}), c→(a→{}, b→{}, c→{}))"

      points(1).toString ===
        "Point(a→(a→{}, b→{}, c→{ac}), b→(a→{}, b→{}, c→{bc}), c→(a→{}, b→{}, c→{c}))"

      points(2).toString ===
        "Point(a→(a→{}, b→{}, c→{ac}), b→(a→{}, b→{b}, c→{bc}), c→(a→{}, b→{}, c→{c}))"

      points(3).toString ===
        "Point(a→(a→{a}, b→{}, c→{ac}), b→(a→{}, b→{}, c→{bc}), c→(a→{}, b→{}, c→{c}))"

      points(4).toString ===
        "Point(a→(a→{a}, b→{}, c→{ac}), b→(a→{}, b→{b}, c→{bc}), c→(a→{}, b→{}, c→{c}))"
    }
    ...
    "exist for Pushout" in {
      ...
      points(1).toString ===
        "Point(a→(a→{}, b→{}, c→{ac}), b→(a→{}, b→{}, c→{}), c→(a→{}, b→{}, c→{c}))"

      points(2).toString ===
        "Point(a→(a→{}, b→{ab}, c→{}), b→(a→{}, b→{b}, c→{}), c→(a→{}, b→{}, c→{}))"

      points(3).toString ===
        "Point(a→(a→{}, b→{ab}, c→{ac}), b→(a→{}, b→{b}, c→{}), c→(a→{}, b→{}, c→{c}))"

      points(4).toString ===
        "Point(a→(a→{a}, b→{ab}, c→{ac}), b→(a→{}, b→{b}, c→{}), c→(a→{}, b→{}, c→{c}))"
    }
